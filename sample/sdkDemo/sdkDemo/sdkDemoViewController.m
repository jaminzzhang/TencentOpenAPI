...
- (void)loadData
{
    ...
    [cellApiInfo addObject:[cellInfo info:@"社交API" target:nil Sel:@selector(pushSelectViewController:) viewController:nil userInfo:[NSNumber numberWithInteger:kApiQuick]]];
...
- (void)pushSelectViewController:(NSNumber *)apiType
{
    ...
    switch ([apiType unsignedIntegerValue]) { 
        ...
        case kApiQQ:
            ...
            break;
        case kApiQuick:
            rootViewController = [[QuickDemoViewController sharedInstance] retain];
            break;
        default:
            break;
    }
